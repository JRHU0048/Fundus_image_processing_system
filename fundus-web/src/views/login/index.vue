  ...
  <div class="login-container">
    ...
    >
      <div class="top-container">
        ...
        <h2 class="title-top">眼底图像处理系统</h2>
      </div>
  ...
  methods: {
    ...
    handleLogin() {
      ...
      this.req({
        url: '/user/login',
        method: 'post',
        // data: that.loginForm,// params,
        data: JSON.stringify(that.loginForm), // 确保数据被转换为JSON字符串
        headers: {
          // 'Content-Type': 'application/x-www-form-urlencoded'
          'Content-Type': 'application/json' // 修改Content-Type为application/json
        }
      }).then(res => {
        console.log(res)
